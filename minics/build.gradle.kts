...
languageProject {
  shared {
    name("Minics")
    defaultPackageId("mb.minics")
    fileExtensions(listOf("mcs"))
  }
  compilerInput {
    withParser().run {
      startSymbol("Start")
...
spoofax2BasedLanguageProject {
  compilerInput {
    ...
    project.languageSpecificationDependency(GradleDependency.project(":minics.spoofaxcore"))
    //project.languageSpecificationDependency(GradleDependency.module("$spoofax2GroupId:minics.spoofaxcore:$spoofax2Version"))
  }
}
