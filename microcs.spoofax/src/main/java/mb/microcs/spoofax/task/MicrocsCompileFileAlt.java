...
@MicrocsScope
public class MicrocsCompileFileAlt implements TaskDef<MicrocsCompileFileAlt.Args, CommandFeedback> {
    ...
    private final MicrocsListLiteralVals listLiteralVals;
    private final ResourceService resourceService;

    @Inject
    public MicrocsCompileFileAlt(MicrocsParse parse, MicrocsListDefNames listDefNames, MicrocsListLiteralVals listLiteralVals, ResourceService resourceService) {
        this.parse = parse;
        this.listDefNames = listDefNames;
