...
@MicrocsScope
public class MicrocsCompileFile implements TaskDef<MicrocsCompileFile.Args, CommandFeedback> {
    ...
    @Inject
    public MicrocsCompileFile(MicrocsParse parse, MicrocsListLiteralVals listLiteralVals, ResourceService resourceService) {
        this.parse = parse;
