 ...
 */
public final class MicrocsIsInj extends StrategoTaskDefBase<MicrocsIsInj.Input, @Nullable IStrategoTerm> {
    ...
    @Override public @Nullable IStrategoTerm exec(ExecContext context, Input input) throws Exception {
        return callStrategy("is-microcs-inj-cons", input.termSupplier.get(context));
    }
}
