 ...
 */
public final class MicrocsUpgradePlaceholders extends StrategoTaskDefBase<MicrocsUpgradePlaceholders.Input, @Nullable IStrategoTerm> {
    ...
    @Inject public MicrocsUpgradePlaceholders(
    ...
    @Override public @Nullable IStrategoTerm exec(ExecContext context, Input input) throws Exception {
        return callStrategy("upgrade-placeholders-microcs", input.termSupplier.get(context));
    }
}
