...
@MinicsScope
public class MinicsCompileDirectory implements TaskDef<MinicsCompileDirectory.Args, CommandFeedback> {
    ...
    @Inject
    public MinicsCompileDirectory(MinicsParse parse, MinicsListDefNames listDefNames, ResourceService resourceService) {
        this.parse = parse;
