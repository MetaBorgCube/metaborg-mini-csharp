...
@MinicsScope
public class MinicsCompileFile implements TaskDef<MinicsCompileFile.Args, CommandFeedback> {
    ...
    @Inject
    public MinicsCompileFile(MinicsParse parse, MinicsListLiteralVals listLiteralVals, ResourceService resourceService) {
        this.parse = parse;
