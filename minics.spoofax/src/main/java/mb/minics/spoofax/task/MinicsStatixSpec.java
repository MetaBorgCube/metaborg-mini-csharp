...
@MinicsScope
public class MinicsStatixSpec implements TaskDef<MinicsStatixSpec.Input, @Nullable Spec> {
    ...
    @Inject public MinicsStatixSpec(
    ...
    @Override
    public String getId() {
        return MinicsStatixSpec.class.getName();
    }
