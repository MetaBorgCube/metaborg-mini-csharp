 ...
 */
public final class MinicsPrettyPrint implements TaskDef<MinicsPrettyPrint.Input, @Nullable String> {
    ...
    @Inject public MinicsPrettyPrint(
        MinicsParse parse,
        ...
        this.log = loggerFactory.create(MinicsPrettyPrint.class);
    }
    ...
    @Override public @Nullable String exec(ExecContext context, Input input) throws Exception {
        ...
        final String strategyId = "pp-partial-minics-string";
        try {
