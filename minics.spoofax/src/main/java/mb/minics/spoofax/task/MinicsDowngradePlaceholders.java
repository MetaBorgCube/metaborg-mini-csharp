 ...
 */
public final class MinicsDowngradePlaceholders extends StrategoTaskDefBase<MinicsDowngradePlaceholders.Input, @Nullable IStrategoTerm> {
    ...
    @Inject public MinicsDowngradePlaceholders(
    ...
    @Override public @Nullable IStrategoTerm exec(ExecContext context, Input input) throws Exception {
        return callStrategy("downgrade-placeholders-minics", input.termSupplier.get(context));
    }
}
